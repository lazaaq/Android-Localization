...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String formatExpirationDate = DateFormat.getDateInstance().format(myDate);
        expiredDateTextView.setText(formatExpirationDate);
        ...
        formattedPrice = mCurrencyFormat.format(mPrice);
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                ...
                if (actionId == EditorInfo.IME_ACTION_DONE) {
                    ...
                    if (v.toString().equals("")) {
                        ...
                        String formattedInput = mNumberFormat.format(mInputQuantity);
                        v.setText(formattedInput);
